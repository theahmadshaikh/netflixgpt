...
const HeroBanner = () => {
  ...
  return (
    <section className="relative w-full h:[99vh] sm:h-[100vh] min-h-[300px] max-h-[100vh] overflow-hidden">
  {trailerKey ? (
    <iframe
...
/>
  ...
  {/* Content */}
  <div className="absolute z-20 bottom-12 sm:bottom-[40%] left-4 sm:left-16 right-4 text-white">
